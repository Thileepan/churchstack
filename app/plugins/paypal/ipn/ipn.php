 ...
 *  PHP-PayPal-IPN
 *
 *  This IpnListener() PHP class to implement a PayPal 
 *  Instant Payment Notification (IPN) listener script.
 *
 *  For a more information, see the blog post:
...
$listener = new IpnListener($APPLICATION_PATH);
...
if ($verified) {
    ...
    */
	...
	$license_obj->updatePurchaseReport($unique_hash, $transaction_id, $payment_mode, $purchase_status, $purchase_remarks, $pg_status_code, $pg_status_remarks);
    mail('support@churchstack.com', 'Verified IPN', $listener->getTextReport());
    ...
    invalid IPN.
    */
    mail('support@churchstack.com', 'Invalid IPN', $listener->getTextReport());
}
