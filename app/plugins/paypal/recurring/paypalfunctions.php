<?php
	...
	********************************************/
	...
	//'------------------------------------
	$API_UserName="sktgthill-facilitator_api1.gmail.com";
	$API_Password="1408191544";
	$API_Signature="AFcWxV21C7fd0v3bYYYRCpSSRl31AyiS2qsbPAQ2oNIRwagSiYeILWk2";
	...
	*/
	...
	{
		//Create billing agreement for future transactions
		session_start();
		$token 		= urlencode($_SESSION['TOKEN']);
