...
create table IF NOT EXISTS PROFILE_CUSTOM_FIELD_VALUES (
	...
	FIELD_VALUE TEXT,
	index PROFILE_CUSTOM_FIELD_VALUES_IDX_1 (PROFILE_ID)
);
...
create table IF NOT EXISTS BATCH_DETAILS (
	...
	index BATCH_DETAILS_IDX_2 (LAST_UPDATED_TIME),
...
create table IF NOT EXISTS CONTRIBUTION_DETAILS (
	...
	LAST_UPDATED_TIME DATETIME,
	LAST_UPDATED_USER_ID BIGINT UNSIGNED,
	LAST_UPDATED_USER_NAME VARCHAR(128),	
