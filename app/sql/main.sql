...
insert into LICENSE_PLANS (PLAN_ID, PLAN_NAME, PLAN_DESCRIPTION, PLAN_TYPE, MAX_COUNT, PRICING, VALIDITY_IN_SECONDS, VALIDITY_IN_DAYS) values (1, 'Trial - Full Featured', 'Full featured trial with no limitations', 1, 200, 0, 2592000, 30);
insert into LICENSE_PLANS (PLAN_ID, PLAN_NAME, PLAN_DESCRIPTION, PLAN_TYPE, MAX_COUNT, PRICING, VALIDITY_IN_SECONDS, VALIDITY_IN_DAYS) values (2, 'Startup - Monthly', 'Monthly plan for a church that has just started to grow', 1, 200, 11.99, 2592000, 30);
insert into LICENSE_PLANS (PLAN_ID, PLAN_NAME, PLAN_DESCRIPTION, PLAN_TYPE, MAX_COUNT, PRICING, VALIDITY_IN_SECONDS, VALIDITY_IN_DAYS) values (3, 'Startup - Yearly', 'Yearly plan for a church that has just started up', 1, 200, 119, 31536000, 365);
insert into LICENSE_PLANS (PLAN_ID, PLAN_NAME, PLAN_DESCRIPTION, PLAN_TYPE, MAX_COUNT, PRICING, VALIDITY_IN_SECONDS, VALIDITY_IN_DAYS) values (4, 'Standard - Monthly', 'Monthly plan for a church that has started growing', 1, 600, 24.99, 2592000, 30);
insert into LICENSE_PLANS (PLAN_ID, PLAN_NAME, PLAN_DESCRIPTION, PLAN_TYPE, MAX_COUNT, PRICING, VALIDITY_IN_SECONDS, VALIDITY_IN_DAYS) values (5, 'Standard - Yearly', 'Yearly plan for a church that has started growing', 1, 600, 249, 31536000, 365);
insert into LICENSE_PLANS (PLAN_ID, PLAN_NAME, PLAN_DESCRIPTION, PLAN_TYPE, MAX_COUNT, PRICING, VALIDITY_IN_SECONDS, VALIDITY_IN_DAYS) values (6, 'Premium - Monthly', 'Monthly plan for a church that is growing at a rapid rate', 1, 1200, 34.99, 2592000, 30);
insert into LICENSE_PLANS (PLAN_ID, PLAN_NAME, PLAN_DESCRIPTION, PLAN_TYPE, MAX_COUNT, PRICING, VALIDITY_IN_SECONDS, VALIDITY_IN_DAYS) values (7, 'Premium - Yearly', 'Yearly plan for a church that is growing at a rapid rate', 1, 1200, 349, 31536000, 365);
insert into LICENSE_PLANS (PLAN_ID, PLAN_NAME, PLAN_DESCRIPTION, PLAN_TYPE, MAX_COUNT, PRICING, VALIDITY_IN_SECONDS, VALIDITY_IN_DAYS) values (8, 'Infinite - Monthly', 'Monthly plan for a church that has grown good and will grow forever', 1, -1, 49.99, 2592000, 30);
