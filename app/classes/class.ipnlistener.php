...
class IpnListener {
    ...
    public function __construct($APPLICATION_PATH)
	{
		...
		$this->use_ssl = PAYPAL_USE_SSL;
		$this->use_sandbox = USE_SANDBOX;
		$this->paypal_host = PAYPAL_LIVE_URL;
		$this->sandbox_host = PAYPAL_SANDBOX_URL;
	}
    ...
    public function getPaypalHost() {
        if ($this->use_sandbox) return $this->sandbox_host;
        else return $this->paypal_host;
    }
