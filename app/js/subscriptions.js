...
function listSubscriptionFields()
{
	document.getElementById('listSubscriptionFields').className = 'active';
	...
	$.ajax({
		...
		url:doSubscribeFile,
		data:formPostData,
		success:listSubscriptionFieldsResponse,
		error:HandleAjaxError
	});
}

function listSubscriptionFieldsResponse(response)
{
	document.getElementById('pageHeader').innerHTML = 'Manage Subscription Fields';
